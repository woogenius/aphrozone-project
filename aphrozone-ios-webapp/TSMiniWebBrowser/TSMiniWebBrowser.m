...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
	...
	{
		if ([[request.URL absoluteString] hasPrefix:@"http://aphro-zone.heroku.com"] ||
			[[request.URL absoluteString] hasPrefix:@"http://aphro-zone.heroku.com"] ||
			[[request.URL absoluteString] hasPrefix:@"http://aphro-zone.heroku.com"]) {
			[[UIApplication sharedApplication] openURL:request.URL];
			return NO;
		}
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error {
    ...
    // Show error alert
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"assCould not load page", nil)
